...
def execute(filters=None):
    columns = [
        ...
        },
        {
            ...
            "label": _("Actual Remaining Balance"),
            "fieldtype": "Currency",
            "options": "currency",
            "width": 170,
        },
        {
            "fieldname": "base_monthly_payment",
            "label": _("Monthly Payment (Company Currency)"),
            "fieldtype": "Currency",
            "options": "company_currency",
            "width": 220,
        },
        {
            "fieldname": "base_remaining_balance",
            "label": _("Actual Remaining Balance (Company Currency)"),
            "fieldtype": "Currency",
            "options": "company_currency",
            "width": 270,
        },
